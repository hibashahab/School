...
<div class="d-flex flex-column justify-content-center flex-wrap text-right first">
    ...
    <p>
        يجب بدالمقدمه بالتعريف عن الكتاب بشكل عام ولكن ليش بشكل واسع جدا بحيث يجب على المقدمه ان تضهر للقارى
        ما يجب توقعه عند قراءه الكتاب, وليس شرح تفصيلي لكل جزء من الكتاب , لذلك يمكن بدء الكتابه بشكل واسع وعام ومن ثم تضيق النطاق قليلا
    </p>
    <div class="d-flex flex-row justify-content-end">
    <button class="btn btn-success mb-1 mr-5" style="width:60px"><a href="/libraryBook" class="text-light" style="text-decoration: none;">تعديل</a></button>  
